...
- (void) presentPopover: (BLCMediaTableViewCell *)cell withFrame:(CGRect) frame {
    ...
    if (itemsToShare.count > 0) {
        ...
        if (isPhone) {
            ...
            [self.cellPopover presentPopoverFromRect:frame inView:cell permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
...
//        CGRect frame;
                ...
                *rect = CGRectMake((width - cell.mediaImageView.frame.size.width)/2, rect->origin.y, cell.mediaImageView.frame.size.width, cell.mediaImageView.frame.size.height);
